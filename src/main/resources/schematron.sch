...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/id[1][not(@nullFlavor)]">
            <assert test="@extension">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[1] должен иметь атрибут @extension</assert>
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.70$')">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[1] должен иметь синтаксически корректное значение атрибута @root, быть сформирован по правилу формирования идентификаторов персонала, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.70".</assert>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/id[1][@nullFlavor]">
            <assert test="@nullFlavor='NA'">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[1] должен иметь значение атрибута @nullFlavor равное 'NA'.</assert>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/id[2]">
            <assert test="@extension">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[2] должен иметь атрибут @extension.</assert>
            <assert test="@root='1.2.643.100.3'">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[2] должен иметь значение атрибута @extension равное '1.2.643.100.3'.</assert>
            <report test="@nullFlavor">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/id[2] не должен иметь атрибут @nullFlavor.</report>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/code">
            <assert test="@codeSystem='1.2.643.5.1.13.13.99.2.700'">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/code должен иметь значение атрибута codeSystem равное '1.2.643.5.1.13.13.99.2.700'.</assert>
            <assert test="@code!=''">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/code должен иметь атрибут @code, представленый не пустым значением.</assert>
            <assert test="@codeSystemName!=''">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/code должен иметь атрибут @codeSystemName, представленый не пустым значением.</assert>
            <assert test="@displayName!=''">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/code должен иметь атрибут @displayName, представленый не пустым значением.</assert>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/assignedPerson">
            <report test="@nullFlavor">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/assignedPerson не должен иметь атрибут @nullFlavor.</report>
            <assert test="count(name)=1">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/assignedPerson должен иметь 1 элемент name.</assert>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization">
            <assert test="count(id)=1">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization должен иметь 1 элемент id.</assert>
            <assert test="count(name)=1">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization должен иметь 1 элемент name.</assert>
            <assert test="count(addr)=1">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization должен иметь 1 элемент addr.</assert>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization/id">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+$')">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization/id должен соответствовать регулярному выражению "([0-2])([.]([1-9][0-9]*|0))+".</assert>
            <report test="@nullFlavor">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization/id не должен иметь атрибут @nullFlavor.</report>
        </rule>
        <rule context="ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization/name">
            <report test="@nullFlavor">У1-19. Элемент ClinicalDocument/legalAuthenticator/assignedAuthor/representedOrganization/name не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У1-20 -->
    <pattern>
        ...
        <rule context="ClinicalDocument/authenticator/assignedAuthor/id[1][not(@nullFlavor)]">
            <assert test="@extension">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[1] должен иметь атрибут @extension</assert>
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.70$')">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[1] должен иметь синтаксически корректное значение атрибута @root, быть сформирован по правилу формирования идентификаторов персонала, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.70".</assert>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/id[1][@nullFlavor]">
            <assert test="@nullFlavor='NA'">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[1] должен иметь значение атрибута @nullFlavor равное 'NA'.</assert>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/id[2]">
            <assert test="@extension">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[2] должен иметь атрибут @extension.</assert>
            <assert test="@root='1.2.643.100.3'">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[2] должен иметь значение атрибута @extension равное '1.2.643.100.3'.</assert>
            <report test="@nullFlavor">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/id[2] не должен иметь атрибут @nullFlavor.</report>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/code[not(@nullFlavor)]">
            <assert test="@codeSystem='1.2.643.5.1.13.13.99.2.700'">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/code должен иметь значение атрибута codeSystem равное '1.2.643.5.1.13.13.99.2.700'.</assert>
            <assert test="@code!=''">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/code должен иметь атрибут @code, представленый не пустым значением.</assert>
            <assert test="@codeSystemName!=''">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/code должен иметь атрибут @codeSystemName, представленый не пустым значением.</assert>
            <assert test="@displayName!=''">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/code должен иметь атрибут @displayName, представленый не пустым значением.</assert>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/assignedPerson">
            <report test="@nullFlavor">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/assignedPerson не должен иметь атрибут @nullFlavor.</report>
            <assert test="count(name)=1">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/assignedPerson должен иметь 1 элемент name.</assert>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/representedOrganization">
            <assert test="count(id)=1">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization должен иметь 1 элемент id.</assert>
            <assert test="count(name)=1">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization должен иметь 1 элемент name.</assert>
            <assert test="count(addr)=1">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization должен иметь 1 элемент addr.</assert>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/representedOrganization/id">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+$')">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization/id должен соответствовать регулярному выражению "([0-2])([.]([1-9][0-9]*|0))+".</assert>
            <report test="@nullFlavor">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization/id не должен иметь атрибут @nullFlavor.</report>
        </rule>
        <rule context="ClinicalDocument/authenticator/assignedAuthor/representedOrganization/name">
            <report test="@nullFlavor">У1-20. Элемент ClinicalDocument/authenticator/assignedAuthor/representedOrganization/name не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У1-21 -->
    <pattern>
